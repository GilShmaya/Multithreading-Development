    ...
    public void runTestsFromFile() {
        ...
        try {
            ...
            for (int i = 0; i < currentTests.length; i++) {
                ...
                System.out.println("starts test " + i);
                Main.main(null);
               // do {
               //     Thread.sleep(10);
              //  } while (!outputFile.exists());
                System.out.println("\r\n\r\nFinished Test --- > " + i);
                int numOfAttacksInTest = diaryInstance.getTotalAttacks();
                ...
                if (numOfAttacksInTest == (currentTests[i].getNumberOfAttacks().get()))
                ...
                System.out.println("\r\n");
                diaryInstance.setTotalAttacks(0);
            }
            System.out.println("\r\n-----------------");
